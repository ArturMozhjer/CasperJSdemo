...
*/
	...
	getBestPrices: function(next) {
		...
		this.Model.find({}, 'Title Cost Image ImageUrl', {sort: {Title: 1}, limit: 10}, function(err, result) {
	...
	getPrices: function(filter, next) {
		...
		try {
			...
			this.Model.find({Title: regexp}, 'Title Cost Image ImageUrl', {sort: {Title: 1}, limit: 10}, function(err, result) {
