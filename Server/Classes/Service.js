...
Service.Properties = {
    ...
    activateModel: function() {
        ...
        this.Schema = new RP.Mongoose.Schema(this.Model, {
        ...
        this.Model = RP.Mongoose.model(this.Name, this.Schema);
	...
	activateRoutes: function() {
		...
		_.each(this.Routes, function(params, path) {
			...
			if (type == 'post') {
				...
				RP.Express.post(path, function(req, res) {

					fn.apply(_this, [req, res, function(data) {

						RP.SendHTTPResult(res, data || '');
				...
				RP.Express.get(path, function(req, res) {
